...
data class CascadeResponse(
    ...
    data class A2AResponse(
        ...
        @Parcelize
        data class Body(
            @SerializedName("CascadeList")
            var cascadeList: CascadeList = CascadeList()
        ) : Parcelable {
            @Parcelize
            data class CascadeList(
                ...
                data class RECORDSETTYPE(
                    @SerializedName("GETCASCADELIST")
                    var gETCASCADELIST: List<GETCASCADELIST> = listOf()
                ) : Parcelable {
                    @Parcelize
                    data class GETCASCADELIST(
